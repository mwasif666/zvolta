...
export const chargerSpecs = {
  "3kw": {
    ...
    seoDescription:
      "Install a Zvolta 3kW smart EV charger for homes, EV bikes, scooters, apartments, small offices, and low use locations. Includes smart software, app control, free standard installation, built-in safety features, 2 year local warranty, and 0% installment options.",
