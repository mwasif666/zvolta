...
export const chargerSpecs = {
  "3kw": {
    ...
    faqs: [
      ...
      [
        "What is included in PKR 74,999?",
  ...
  "7kw": {
    ...
    technicalSpecs: [
      ["Capacity - Input voltage", "1 Phase, 230V AC"],
      ["Capacity - Frequency", "50 Hz"],
      ["Capacity - Rated Output Power/current", "7KVA/32A"],
      ["Output - AC output voltage", "1 Phase, 230V AC"],
      ["Output - Frequency", "50 Hz"],
      ["Output - Socket", "Type 2 Gun"],
      ["Product Dimensions - Length", "3.5mm"],
      ["Product Dimensions - Height", "700mm"],
      ["Product Dimensions - Depth", "175mm"],
      ["Protection & Security - Ingress Protection", "IP54"],
      ["Protection & Security - Tempered detection", "Yes"],
      ["Protection & Security - Overload Protection", "Yes"],
      ["Protection & Security - RCD (30 A) AC", "Yes"],
      ["Protection & Security - Surge protection Level 3", "Yes"],
      ["Protection & Security - Over voltage Protection", "Yes"],
      ["Connectivity - Wifi", "Yes"],
      ["Connectivity - GSM", "Yes"],
      ["Connectivity - LED Indication", "Yes"],
      ...
      ["Other - Material", "MS"],
      ["Other - Authentication method", "Application"],
      ["Environmental Specifications - Operating temperature", "0°C to +60°C"],
      ["Environmental Specifications - Humidity", "upto 95%"],
      ["Power Connection - Red", "Live"],
      ["Power Connection - Blue", "Neutral"],
      ["Power Connection - Yellow/Green", "Earth/Ground"],
  ...
  "22kw": {
    ...
    technicalSpecs: [
      ["Capacity - Input voltage", "3 Phase, 400V AC"],
      ["Capacity - Frequency", "50 Hz"],
      ["Capacity - Rated Output Power/current", "22KVA/32A"],
      ["Output - AC output voltage", "3 Phase, 400V AC"],
      ["Output - Frequency", "50 Hz"],
      ["Output - Socket", "Type 2 Gun"],
      ["Product Dimensions - Length", "3.5mm"],
      ["Product Dimensions - Height", "700mm"],
      ...
      ["Environmental Specifications - Operating temperature", "0°C to +60°C"],
      ["Environmental Specifications - Humidity", "upto 95%"],
      ["Power Connection - Red", "L1"],
      ["Power Connection - Yellow", "L2"],
      ["Power Connection - Blue", "L3"],
      ["Power Connection - Black", "Neutral"],
      ["Power Connection - Yellow/Green", "Earth/Ground"],
    ],
    pricing: [
