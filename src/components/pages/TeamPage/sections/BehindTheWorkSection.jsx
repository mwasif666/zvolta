    ...
    <Section>
      ...
      <div className="team-carousel mt-12 flex snap-x gap-6 overflow-x-auto pb-4">
        {behindWork.map((item, index) => (
          <article
            key={item.title}
            className="team-reveal group w-[260px] shrink-0 snap-start rounded-lg border border-[#1F1F1F] bg-[#111111] p-4 transition duration-300 hover:-translate-y-1 hover:border-[#16a34a]/40 sm:w-[310px]"
          >
