    ...
    <Section>
      ...
      <div className="team-reveal mt-12 rounded-lg border border-[#1F1F1F] bg-[#111111] p-6 md:p-8">
        <div className="relative grid gap-5 lg:grid-cols-4">
          <div
            ref={processLineRef}
            className="absolute left-0 top-8 hidden h-px w-full bg-[#16a34a]/45 lg:block"
          />
          {workSteps.map((step, index) => (
            ...
            >
              <span className="grid h-10 w-10 place-items-center rounded-full bg-[#16a34a] text-sm font-semibold text-black">
                0{index + 1}
              </span>
